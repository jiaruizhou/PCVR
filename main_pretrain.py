...
from util.custom_datasets import pretrain_Dataset
import models_mae
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='mae_vit_base_patch4_6mer', type=str, metavar='MODEL', help='Name of model to train')
...
def main(args):
    ...
    dataset_train = pretrain_Dataset(root_dir=args.data_path, kmer=args.kmer)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and (epoch % 30 == 0 or epoch % 20 == 0 or epoch + 1 == args.epochs):
